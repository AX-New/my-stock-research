...
| 项目名称 | 项目位置 | 项目作用 |
|----------|----------|----------|
| my-stock | F:\projects\my-stock | 数据同步、展示、轻量分析 |
| my-trend | 腾讯云：/root/my-claude/my-trend | 舆情数据、热度数据实时抓取（**无本地副本**） |

> **my-trend 必须在腾讯云上开发和测试**（`ssh root@154.8.136.130`），本地无副本。
> 该项目依赖腾讯云的 MySQL、crontab 和代理环境，本地无法运行。
